...
class Dmsf144 < ActiveRecord::Migration[5.2]
  ...
  def self.up
    ...
    add_column :dmsf_file_locks, :lock_type, :integer, :default => true, :null => true
    add_column :dmsf_file_locks, :lock_scope, :integer, :default => true, :null => true
    ...
    DmsfFileLock.update_all ['entity_type = ?, lock_type = ?, lock_scope = ?', 0, 0, 0]

    #These are not null-allowed columns
    change_column :dmsf_file_locks, :entity_type, :integer, :null => false
    change_column :dmsf_file_locks, :lock_type, :integer, :null => false
    change_column :dmsf_file_locks, :lock_scope, :integer, :null => false
  ...
  def self.down
    ...
    remove_column :dmsf_file_locks, :lock_type
    remove_column :dmsf_file_locks, :lock_scope
